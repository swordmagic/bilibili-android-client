...
public class HomeLiveFragment extends RxLazyFragment {
    ...
    protected void initRecyclerView() {
        ...
        mLiveAppIndexAdapter.setSpanCount(12);
        GridLayoutManager layout = new GridLayoutManager(getActivity(), mLiveAppIndexAdapter.getSpanCount());
        layout.setSpanSizeLookup(mLiveAppIndexAdapter.getSpanSizeLookup());
